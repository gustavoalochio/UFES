...
${OBJECTDIR}/tJogador.o: tJogador.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tJogador.o tJogador.c

${OBJECTDIR}/tJogo.o: tJogo.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tJogo.o tJogo.c

${OBJECTDIR}/tTabuleiro.o: tTabuleiro.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tTabuleiro.o tTabuleiro.c
